@echo off
REM Windows setup script for Docker

REM Create data directories
if not exist "data" mkdir data
if not exist "routing_data" mkdir routing_data
...
echo   copy "C:\path\to\your\route.gpkg" ".\data\"
echo   copy "C:\path\to\your\unique_cluj.geojson" ".\data\"
echo   copy "C:\path\to\your\viteze_drum300.gpkg" ".\data\"
echo.
